...
<script>
  ...
  export default {
    ...
    created(){
      var list =[]
      var masterWendaOrder=[]
      var userwaitToCommit=[]
      var userwaitingPayRes=[]
      for(let i =0;i<JSON.parse(sessionStorage.getItem("masterWendaOrder")).orders.length;i++ ){
        masterWendaOrder.push(JSON.parse(sessionStorage.getItem("masterWendaOrder")).orders[i])
      }
