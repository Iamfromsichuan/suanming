...
<script>
  ...
  export default {
    ...
    created(){
      ...
      for(let i =0;i<JSON.parse(sessionStorage.getItem("masterAllOrder")).orders.length;i++ ){
        masterAllOrder.push(JSON.parse(sessionStorage.getItem("masterAllOrder")).orders[i])
      }
      this.orders = masterAllOrder
